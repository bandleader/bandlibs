...
function compile$1$1(template, options = {}) {
...
function compileToFunction(template, options) {
    ...
    const { code } = compile$1$1(template, extend({
        hoistStatic: true,
        onError: onError ,
...
var VCP = /*#__PURE__*/Object.freeze({
  ...
  'default': vueClassPlus,
  vueClassPlus: vueClassPlus
});
...
function initApp(Vue) {
    ...
    hook(w.app, 'component', function (old) { return function (name, value) {
        ...
        return old.apply(void 0, __spreadArray([name, vueClassPlus(value)], args, false));
    }; });
    // Support vug
    hook(w.app, 'component', function (old) { return function (name, value) {
        var args = [];
