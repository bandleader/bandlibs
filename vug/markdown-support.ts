...
import { marked } from '../node_modules/marked/lib/marked.esm.js' // not sure why I can't do just 'marked'. Also not sure why only when BUILDING, it fails unless I add the '.js'.
